...
def TF_IDF(dataMatrix):
    ...
    # apply TF-IDF 
    dataMatrix.data = dataMatrix.data * idf[dataMatrix.col]
    ...
    def compute_similarity(self, start_col=None, end_col=None, block_size = 100):
        ...
        while start_col_block < end_col_local:
            ...
            for col_index_in_block in range(this_block_size):
                ...
                top_k_idx = relevant_items_partition[relevant_items_partition_sorting] #각 아이템별 topk유사 아이템
...
class BaseItemSimilarityMatrixRecommender(BaseSimilarityMatrixRecommender):
    ...
    def _compute_item_score(self, user_id_array, items_to_compute=None):
        ...
        user_profile_array = self.URM_train[user_id_array] #유저*아이템 중 필요한 유저만 뽑음
        ...
        return item_scores #특정유저에 대한 아이템 추천 점수.
...
class item_CF(BaseItemSimilarityMatrixRecommender):
    ...
    def fit(self, topK=50, shrink=100, similarity='cosine', normalize=True, feature_weighting = "none", **similarity_args):
        ...
        self.W_sparse = similarity.compute_similarity() #아이템간 유사도
